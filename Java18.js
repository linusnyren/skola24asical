...
function main() {
  ...
  app.get('/', (req, res) => {
    res.send('To get schedule for Java18 enter this sites url following /Java18')
  })

  app.get('/Java18', (req, res) => {
...
function get_events(domain, school, group, week, callback) {
  ...
  const body = {
    ...
    "selectedClass":{
      "id":"Java18",
      "guid":"NGNjZDQzOTAtZWRiNC1mNDc1LWI5YTctODE1OTNiYzU0NDc2",
      "isClass":true
    },
    "selectedRoom":null,
